...
pub(crate) async fn load_persisted_series_resource(
    pool: &SqlitePool,
    series_id: &str,
...
pub(crate) async fn load_series_id_by_sorted_position(
    pool: &SqlitePool,
    index: usize,
...
pub(crate) async fn load_persisted_series_detail(
    pool: &SqlitePool,
    series_id: &str,
...
pub(crate) async fn load_persisted_series_collections(
    pool: &SqlitePool,
    series_id: &str,
...
pub(crate) async fn load_existing_series_metadata(
    pool: &SqlitePool,
    series_id: &str,
...
pub(crate) async fn persist_series_metadata_update(
    pool: &SqlitePool,
    series_id: &str,
