...
use komga_infrastructure_base::sqlite::{connect_shared_pool, default_read_max_connections};
...
mod tests {
    use super::*;
    use komga_infrastructure_base::sqlite::{bootstrap_tasks_pool, connect_task_write_pool};
